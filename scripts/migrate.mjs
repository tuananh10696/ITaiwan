...
const THU_TU = [
  ...
  'migration-cong-dong.sql',
  'migration-cong-dong-seed.sql',
  'migration-to-chuc-quyen.sql',
  'migration-thanh-toan.sql',
  'migration-gia-bac-thang.sql',
  'migration-combo-tron-bo.sql',
